...
const updateCourseIntoDB = async (id: string, payload: Partial<TCourse>) => {
  ...
  try {
    ...
    onFailure(updatedBasicCourseInfo, 'Failed to update course!');
    ...
    if (preRequisiteCourses && preRequisiteCourses.length > 0) {
      ...
      onFailure(deletedPreRequisiteCourses, 'Failed to update course!');
      ...
      onFailure(newPreRequisiteCourses, 'Failed to update course!');
    }
